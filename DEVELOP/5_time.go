...
func main() {
	...
	funcMap := template.FuncMap{key: value} // инициализируем объект спецмапу из библиотеки html-шаблонов для записи в неё функциий и сразу инициализируем в ней запись алиаса date который ссылается на функцию formatDate
